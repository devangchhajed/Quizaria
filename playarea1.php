...
/*	
	echo "<script>alert('The First Round of the quiz is over.'); window.location='/'</script>";
	exit(0);
...
<div class=" col-sm-2">
	...
	<div id="pcover" style="height:50%; width:100%; display:cover; z-index:9; position:absolute; background-color:rgba(1,0,0,0.9); color:white; border: 1px solid; text-align:center; display:none;">
		<h1>Processing</h1>
	</div>
	...
	<div id="questionDIV" style="width:100%; z-index:1;">
		<div class="row well">
		Question 1: <?php echo $questions[$index]['ques'];?>
		</div>
		<input type="hidden" id="questionID" value="<?php echo $index; ?>">
		<input type="hidden" id="questionNumber" value="0">
			<input type="hidden" id="timeStart" value="1200">	
			<div class="row" style="width:100%">

			<button type="button" style="margin:10px;" id="answer1" onclick="answer(this)" class="btn btn-primary"><?php echo $questions[$index]['ans1'];?></button>
			<button type="button" style="margin:10px;"  id="answer2" onclick="answer(this)"  class="btn btn-primary"><?php echo  $questions[$index]['ans2'];?></button>
		</div>
		<div class="row" style="width:100%">
			<button type="button" style="margin:10px;" id="answer3" onclick="answer(this)" class="btn btn-primary"><?php echo $questions[$index]['ans3'];?></button>
			<button type="button" style="margin:10px;" id="answer4" onclick="answer(this)" class="btn btn-primary"><?php echo $questions[$index]['ans4'];?></button>
		</div>
